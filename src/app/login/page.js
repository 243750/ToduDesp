...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-todu-bg flex flex-col items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-todu-surface border border-todu-border rounded-[2rem] shadow-2xl p-8">
        <div className="flex flex-col items-center mb-8">
          <ToduLogo size={88} withWordmark />
          <p className="text-todu-text-muted text-sm mt-2">Ingresa a tu cuenta para continuar</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <div>
            <label className="block text-xs font-bold text-todu-text-muted uppercase tracking-wider mb-2">
              Correo electrónico
            </label>
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full bg-todu-bg border border-todu-border rounded-xl pl-11 pr-11 py-3 text-sm text-todu-text placeholder-todu-text-muted outline-none focus:border-violet-500/50 transition-colors"
          ...
          <div>
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full bg-todu-bg border border-todu-border rounded-xl pl-11 pr-4 py-3 text-sm text-todu-text placeholder-todu-text-muted outline-none focus:border-violet-500/50 transition-colors"
                placeholder="••••••••"
                required
              />
              <button
